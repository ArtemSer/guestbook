...
class GuestbookControllerUnitTests {
	...
	void populatesModelForGuestbook() {
		...
		GuestbookEntry entry = new GuestbookEntry("Yoda", "May the 4th b with you!", "Star Wars", "Luke");
		...
		String viewName = controller.guestBook(model, new GuestbookForm(null, null, null, null));
